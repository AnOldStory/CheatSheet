/* PrismJS 1.15.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+c+csharp+autohotkey+bash+basic+cpp+aspnet+arduino+css-extras+django+docker+markup-templating+fortran+git+go+graphql+less+http+hpkp+hsts+java+javastacktrace+json+kotlin+markdown+lua+makefile+matlab+nginx+objectivec+ocaml+php+php-extras+sql+powershell+python+r+jsx+typescript+plsql+pug+tsx+vbnet+vim+visual-basic+wiki&plugins=toolbar+copy-to-clipboard */
